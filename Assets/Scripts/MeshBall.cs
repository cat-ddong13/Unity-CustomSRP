...
public class MeshBall : MonoBehaviour
{
    ...
    [SerializeField] private LightProbeProxyVolume lppv = null;
    ...
    private void UpdateDraw()
    {
        ...
        Graphics.DrawMeshInstanced(mesh, 0, material, matrices, 1023, block,
            ShadowCastingMode.On, true, 0, null, lppv ? LightProbeUsage.UseProxyVolume : LightProbeUsage.CustomProvided,
            lppv);
    }
