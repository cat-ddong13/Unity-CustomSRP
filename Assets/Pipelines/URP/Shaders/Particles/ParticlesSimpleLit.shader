...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesDepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesDepthNormalsPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesEditorPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/UnlitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Utils/Universal2D.hlsl"
            ENDHLSL
        }
    }
