...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Particles/ParticlesLitGbufferPass.hlsl"
            ENDHLSL
        }
