Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/BakedLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/BakedLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/BakedLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/BakedLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/BakedLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/DepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/BakedLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/BakedLitMetaPass.hlsl"
