Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Terrain/TerrainDetailLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Terrain/TerrainDetailLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/ShaderLibrary/UnityGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Terrain/TerrainLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/SimpleLitMetaPass.hlsl"
            ENDHLSL
        }
    }
