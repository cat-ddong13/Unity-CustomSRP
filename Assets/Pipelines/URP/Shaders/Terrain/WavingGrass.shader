...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Terrain/WavingGrassPasses.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Pipelines/URP/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/Pipelines/URP/Shaders/Terrain/WavingGrassDepthNormalsPass.hlsl"
            ENDHLSL
        }
    }
}
