...
- Added support for [Screen Space Ambient Occlusion](https://docs.unity3d.com/Assets/Pipelines/URP@10.0/manual/post-processing-ssao.html) and a new shader variant _SCREEN_SPACE_OCCLUSION.
...
- Added new sections to documentation: [Writing custom shaders](https://docs.unity3d.com/Assets/Pipelines/URP@10.0/manual/writing-custom-shaders-urp.html), and [Using the beginCameraRendering event](https://docs.unity3d.com/Assets/Pipelines/URP@10.0/manual/using-begincamerarendering.html).
