    ...
    internal sealed class BuiltInToURP2DMaterialUpgrader : RenderPipelineConverter
    {
        ...
        public override void OnInitialize(InitializeConverterContext context, Action callback)
        {
            ...
            if (data != null)
                ...
                m_SpriteLitDefaultMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/Pipelines/URP/Runtime/Materials/Sprite-Lit-Default.mat");

            m_SpritesDefaultMat = AssetDatabase.GetBuiltinExtraResource<Material>("Sprites-Default.mat");
            m_SpriteMaskDefaultMat = AssetDatabase.LoadAssetAtPath<Material>("Assets/Pipelines/URP/Runtime/Materials/SpriteMask-Default.mat");
