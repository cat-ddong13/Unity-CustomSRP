...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalSpriteLitSubTarget : SubTarget<UniversalTarget>, ILegacyTarget
    {
        ...
        {
            const string k2DLightingUtil = "Assets/Pipelines/URP/Shaders/2D/Include/LightingUtility.hlsl";
            const string k2DNormal = "Assets/Pipelines/URP/Shaders/2D/Include/NormalsRenderingShared.hlsl";
            const string kSpriteLitPass = "Assets/Pipelines/URP/Editor/2D/ShaderGraph/Includes/SpriteLitPass.hlsl";
            const string kSpriteNormalPass = "Assets/Pipelines/URP/Editor/2D/ShaderGraph/Includes/SpriteNormalPass.hlsl";
            const string kSpriteForwardPass = "Assets/Pipelines/URP/Editor/2D/ShaderGraph/Includes/SpriteForwardPass.hlsl";
