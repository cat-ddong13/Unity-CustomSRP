...
namespace UnityEditor.Rendering.Universal.Converters
{
    ...
    internal static class ReadonlyMaterialMap
    {
        ...
        {
            {"Default-Diffuse", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
            {"Default-Material", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
            {"Default-ParticleSystem", "Assets/Pipelines/URP/Runtime/Materials/ParticlesUnlit.mat"},
            {"Default-Particle", "Assets/Pipelines/URP/Runtime/Materials/ParticlesUnlit.mat"},
            {"Default-Terrain-Diffuse", "Assets/Pipelines/URP/Runtime/Materials/TerrainLit.mat"},
            {"Default-Terrain-Specular", "Assets/Pipelines/URP/Runtime/Materials/TerrainLit.mat"},
            {"Default-Terrain-Standard", "Assets/Pipelines/URP/Runtime/Materials/TerrainLit.mat"},
            {"Sprites-Default", "Assets/Pipelines/URP/Runtime/Materials/Sprite-Unlit-Default.mat"},
            {"Sprites-Mask", "Assets/Pipelines/URP/Runtime/Materials/Sprite-Unlit-Default.mat"},
            {"SpatialMappingOcclusion", "Assets/Pipelines/URP/Runtime/Materials/SpatialMappingOcclusion.mat"},
            {"SpatialMappingWireframe", "Assets/Pipelines/URP/Runtime/Materials/SpatialMappingWireframe.mat"},

            // TODO: These currently render in URP, but they are using BIRP shaders. Create a task to convert these.
            // {"Default UI Material", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
            // {"ETC1 Supported UI Material", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
            // {"Default-Line", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
            // {"Default-Skybox", "Assets/Pipelines/URP/Runtime/Materials/Lit.mat"},
        };
    }
