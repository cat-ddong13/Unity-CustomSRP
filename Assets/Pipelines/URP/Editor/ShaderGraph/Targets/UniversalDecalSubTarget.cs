    ...
    sealed class UniversalDecalSubTarget : SubTarget<UniversalTarget>
    {
        ...
        static class DecalPasses
        {
            public static PassDescriptor ScenePicking = new PassDescriptor()
            {
                ...
                // Template
                passTemplatePath = "Assets/Pipelines/URP/Editor/Decal/DecalPass.template",
        ...
        {
            const string kDecalInput = "Assets/Pipelines/URP/ShaderLibrary/DecalInput.hlsl";
            const string kShaderVariablesDecal = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/ShaderVariablesDecal.hlsl";
            const string kPassDecal = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/ShaderPassDecal.hlsl";
            ...
            const string kGBuffer = "Assets/Pipelines/URP/ShaderLibrary/UnityGBuffer.hlsl";
