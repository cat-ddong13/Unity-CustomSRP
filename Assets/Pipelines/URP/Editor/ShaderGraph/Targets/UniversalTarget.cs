...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
...
#endif
    {
        ...
        {
            "Assets/Pipelines/URP/Editor/ShaderGraph/Templates"
#if HAS_VFX_GRAPH
            , "Packages/com.unity.visualeffectgraph/Editor/ShaderGraph/Templates"
#endif
        }).ToArray();
        public const string kUberTemplatePath = "Assets/Pipelines/URP/Editor/ShaderGraph/Templates/ShaderPass.template";
    ...
    static class CoreIncludes
    {
        ...
        const string kCore = "Assets/Pipelines/URP/ShaderLibrary/Core.hlsl";
        const string kLighting = "Assets/Pipelines/URP/ShaderLibrary/Lighting.hlsl";
        const string kGraphFunctions = "Assets/Pipelines/URP/ShaderLibrary/ShaderGraphFunctions.hlsl";
        const string kVaryings = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/Varyings.hlsl";
        const string kShaderPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/ShaderPass.hlsl";
        const string kDepthOnlyPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl";
        const string kDepthNormalsOnlyPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/DepthNormalsOnlyPass.hlsl";
        const string kShadowCasterPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl";
        const string kTextureStack = "Packages/com.unity.render-pipelines.core/ShaderLibrary/TextureStack.hlsl";
        const string kDBuffer = "Assets/Pipelines/URP/ShaderLibrary/DBuffer.hlsl";
        const string kSelectionPickingPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/SelectionPickingPass.hlsl";
