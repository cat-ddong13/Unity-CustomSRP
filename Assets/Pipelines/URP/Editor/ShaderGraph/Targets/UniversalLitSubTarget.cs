...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalLitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        ...
        {
            const string kShadows = "Assets/Pipelines/URP/ShaderLibrary/Shadows.hlsl";
            const string kMetaInput = "Assets/Pipelines/URP/ShaderLibrary/MetaInput.hlsl";
            const string kForwardPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl";
            const string kGBuffer = "Assets/Pipelines/URP/ShaderLibrary/UnityGBuffer.hlsl";
            const string kPBRGBufferPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/PBRGBufferPass.hlsl";
            const string kLightingMetaPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl";
            const string k2DPass = "Assets/Pipelines/URP/Editor/ShaderGraph/Includes/PBR2DPass.hlsl";
